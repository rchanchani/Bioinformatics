...
## Barplot
Adjust the margin sizes to include all y-axis labels with par(mar=c(...))
Create a horizontal barplot with feature names in y-axis and counts in x-axis and a histogram with different coloring schemes, based on the number of bins.
```{r}
...
Dynamic use of color. Set color based on density of non-zero expression methylation datapoints.
